...
# start the build
docker exec $CONTAINER bash -c "cd /home/support/bird2 && bash -xe build-bird-2.0.4-3.df.sh ${GIT_BRANCH}"
# retrieve the debian from the container
docker cp $CONTAINER:/home/support/bird2/bird2-2.0.4-3.df-amd64.deb .
